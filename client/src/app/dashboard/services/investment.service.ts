...
export class InvestmentService {
  ...
  public addInvestment(userId: string, deposit: number): Observable<ServerResponse<CreateInvestmentResponse>> {
    return this.http.post<ServerResponse<CreateInvestmentResponse>>(
      apis.addInvestment, { userId, deposit }, { withCredentials: true }
    );
  }
